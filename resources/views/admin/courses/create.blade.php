...
@section('title')
    @include('admin.courses.partials.title')
@endsection
@section('styles')
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('course.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first"  class="row g-3 needs-validation @if($errors->any())was-validated @endif">
                    @csrf
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea  class="form-control" rows="10" cols="50"  name="syllabus" required id="syllabus" value="{{ old('syllabus') }}"></textarea>
                            @error('syllabus')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea  class="form-control" rows="10" cols="50"  name="pattern" required id="pattern" value="{{ old('pattern') }}"></textarea>
                            @error('pattern')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea  class="form-control" rows="10" cols="50"  name="criteria" required id="criteria" value="{{ old('criteria') }}"></textarea>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="amount" required id="amount" value="{{ old('amount') }}" >
                            @error('amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
