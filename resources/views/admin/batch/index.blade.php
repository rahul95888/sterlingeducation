                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:10%;">{{ $data->startTime }}</td>
                                  ...
                                  <td>
                                    <a class="btn btn-primary btn-sm me-3" title="Edit FPO Details" href="{{ route('batch.edit', $data['id']) }}">
                                        <i class="bx bx-edit"></i>
                                    </a>
                                     <button class="btn btn-danger btn-sm deleteItem" title="Delete FPO" data-id="{{$data['id']}}">
                                        <i class="bx bx-trash"></i>
                                    </button>
                                    <form id="deleteForm{{$data['id']}}" action="{{route('batch.destroy', [$data['id']])}}" method="post" style="display:none">
                                        @csrf
                                        @method('delete')
