    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation @if($errors->any())was-validated @endif">
                    @csrf
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="form-label" for="service_name">Service Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="service_name" id="service_name" value="{{ old('service_name') }}" required>
                            @error('service_name')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="commodity_uid" id="commodity_uid" class="form-control" cols="30" rows="10" required>{{ old('commodity_uid') }}</textarea>
                            @error('commodity_uid')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
