                ...
                <div class="table-responsive">
                    <table id="services_table" class="table table-striped table-bordered" style="width:100%">
                        ...
                        @php($i = "1")
                            ...
                            <td><a class="btn btn-primary btn-sm me-3" title="Edit Service Details" href="{{ route('teacher.edit', $data->id) }}">
                                        <i class="bx bx-edit"></i>
                                    </a>
                                    <button class="btn btn-danger btn-sm deleteItem" title="Delete Service" data-id="{{$data['id']}}">
                                        <i class="bx bx-trash"></i>
                                    </button>
                                    <form id="deleteForm{{$data->id}}" action="{{route('teacher.destroy', [$data->id])}}" method="post" style="display:none">
                                        @csrf
                                        @method('delete')
