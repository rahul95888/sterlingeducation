    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('videolesson.store') }}" method="POST" data-parsley-validate data-parsley-focus="first" enctype="multipart/form-data" class="row g-3 needs-validation @if($errors->any())was-validated @endif">
                    @csrf
                    <div class="col-md-12">
