...
<div id="wrapper" class="clearfix">
  ...
  <div class="container pt-20 pb-20">
    ...
    <div class="section-content">
      <div class="row">
        <div class="col-md-12">
          <h2 class="title text-black text-center">{{$courselist->title}}</h2>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-4">
            <div class="sidebar sidebar-right mt-sm-30 ml-40">
              <div class="widget">
                <h4 class="widget-title line-bottom centertext">COURSES <span class="text-theme-color-2">List</span></h4>
                <div class="services-list">
                  <ul class="list list-border angle-double-right">
                  @foreach($courseitem as $key=>$value)

                  <li class="{{$courselist->id ==$value->id ? 'active' : ''}}"><a href="{{URL::to('coursedetail/'.$value->slug)}}">{!! $value->title !!}</a>
                  </li>
                    @endforeach
