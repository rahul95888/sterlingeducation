                        ...
                        <div class="col-lg-8 primary right-sidebar">
                           <div class="single-packge-wrap">
                              ...
                              <figure class="single-package-image">
                                 <img src="{{url('/uploads/property/'.$data->thumb)}}" alt="">
                              </figure>
            ...
            <div class="gallery-section">
              ...
              <div class="single-gallery grid-item">
                  <figure class="gallery-img">
                    ...
                    <a href="{{url('/uploads/property/'.$img->image)}}" data-fancybox="gallery">
                      <img src="{{url('/uploads/property/'.$img->image)}}" alt="" />
                    </a>
                  </figure>
                </div>
            @endforeach
...
@endif
                                    <h3>BOOKING FORM</h3>
                                    <form action="{{ route('sendEnquiry-123') }}" method="POST"   class="row g-3 booking-form needs-validation @if($errors->any())was-validated @endif">
                    @csrf
                                      ...
                                      <div class="invalid-feedback">{{ $message }}</div>
                                       ...
                                       <select name="requirement" class="w-100">
...
<option value="238">    Verde  +238Cape Islands </option>
<option value="1345">   Islands Cayman +1345 </option>
...
<option value="240 ">   Eq  uatorial Guinea  +240</option>
...
<option value="1787">    Puerto  +1787 Rico </option>
<option value="974">    Qatar  +974 </option>
<option value="262">    Reunion  +262 </option>
<option value="40">    Romania  +40 </option>
<option value="7">    Russia  +7 </option>
<option value="250">    Rwanda  +250 </option>
<option value="378">    San  +378 Marino </option>
...
<option value="379">    Vatican  +379 City </option>
...
<option value="263">    Zimbabwe  +263 </option>
                                       ...
                                       <input type="number"   name="mob" placeholder="Your Number*">
                                    </p>
                                       <p>
                                       <!-- <input type="hidden" name="package"  value="{{$data->equipment_name}}"> -->
