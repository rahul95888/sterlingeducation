...
<div class="container pt-20 pb-20">
    ...
    <div class="section-content">
      <div class="row">
        <div class="col-md-12">
          <h2 class="title text-black centertext">VIDEO COURSES  </h2>
        </div>
      </div>
    </div>
  </div>
                  ...
                  <div class="product-thumb"> 
                    ...
                    <div class="overlay">
                      ...
                      <div class="btn-product-view-details">
                        <a class="btn btn-default btn-theme-colored btn-sm btn-flat pl-20 pr-20 btn-add-to-cart text-uppercase font-weight-700" href="{{ URL('/video-lesson-detail/'.$value->slug) }}">View detail</a>
                      </div>
                    </div>
                  </div>
